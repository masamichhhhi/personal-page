...
## 私がブラウザに求めていること
- 私は集中が散漫になりやすい。不要な情報が目に入るとすぐにそれに注意をむけてしまうし、何の作業をやっていたかすぐ忘れる。
- そんな自分には無駄な作業やいらない情報が少しでも入らないような工夫が必要だと思っている。そんな人のためのArcブラウザである。
- 開発作業中にブラウザを使う場合、自分の集中状態を維持し続けられるかが重要
  - ブラウジングという作業を、どれだけ早く脳のメモリから早く解放できるか、が大事だと考えている
